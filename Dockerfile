...
WORKDIR /app
COPY --chown=node:node package.json server.js database.js import-catalog.js kaishu-import.js matching.js index.html admin.html app.js admin.js upload-board.js shared.js artwork.js style.css admin.css ./
