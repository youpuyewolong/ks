...
function createApp({ dataDir = process.env.DATA_DIR || path.join(__dirname, 'data'), password = process.env.ADMIN_PASSWORD || '', seedCatalogs = false, importFetch = fetch } = {}) {
  ...
  const server = http.createServer(async (req, res) => {
    ...
    try {
      ...
      const assets = { "/upload-board.js":"upload-board.js", "/matching.js":"matching.js", '/': 'index.html', '/index.html': 'index.html', '/admin': 'admin.html', '/admin/': 'admin.html', '/admin.html': 'admin.html', '/app.js': 'app.js', '/admin.js': 'admin.js', '/artwork.js': 'artwork.js', '/shared.js': 'shared.js', '/style.css': 'style.css', '/admin.css': 'admin.css' };
